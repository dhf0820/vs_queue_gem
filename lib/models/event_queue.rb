...
class EventQueue
  ...
  def initialize(customer_name, container_name, container_id)
    ...
    #@hostname = $hostname
    @queue_name = "#{customer_name}_events"
  ...
  def self.post(facility, metric_name, identifier, id_type, metric, metric_type, divisors, tags, comment = "")
    ...
    @@current.send(facility, metric_name, identifier, id_type, metric,  divisors, tags, comment)
  end
  ...
  def send(facility, metric_name, identifier, id_type, metric, divisors, tags, comment = '')
    e = {}
